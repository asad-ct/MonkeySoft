                        ...
                        <React.Fragment key={index}>
                            {props.testimonials.map(({ text, image, name, role }, i) => (
                                <motion.li
                                    ...
                                    className="rounded-3xl border border-neutral-200 dark:border-neutral-800 shadow-lg shadow-black/5 max-w-xs w-full bg-white dark:bg-neutral-900 transition-all duration-300 cursor-default select-none group focus:outline-none focus:ring-2 focus:ring-primary/30"
                                >
                                    <blockquote className="m-0 p-10">
                                        <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed font-normal m-2 transition-colors duration-300">
                                            {text}
                                        </p>
...
export const TestimonialsSection = () => {
    return (
        <section
            ...
            className="bg-transparent py-24ranspt4r relative overflow-hidden"
        >
            {/* Celestial Bloom Animation - Top Left with Blur */}
            <div className="absolute top-10 left-0 w-[500px] h-[500px] -mr-20 -mt-30 z-0 pointer-events-none">
                <div className="absolute inset-0 blur-3xl bg-gradient-to-br from-transparent via-black/30 to-transparent" />
            ...
            >
                <div className="flex flex-col items-center justify-center max-w-[540px] mx-auto mb-16 mt-20">
...
// --- Main App Component (standalone demo with dark mode toggle) ---
